...
variable "redirects" {
  default = [
    ...
    { key = "/concepts/changelogs/attributes/sql-plus-troubleshoot.html", website_redirect = "/tools-integrations/native-executors/sql-plus-troubleshoot.html" },
    { key = "/concepts/changelogs/attributes/use-psql-integration.html", website_redirect = "/tools-integrations/native-executors/use-psql-integration.html" },
    { key = "/concepts/changelogs/attributes/use-sqlcmd-integration.html", website_redirect = "/tools-integrations/native-executors/use-sqlcmd-integration.html" },
    { key = "/concepts/changelogs/attributes/use-sql-plus-integration.html", website_redirect = "/tools-integrations/native-executors/use-sql-plus-integration.html" },
    { key = "/concepts/changelogs/attributes/use-sql-plus-oracle-proxy-server.html", website_redirect = "/tools-integrations/native-executors/use-sql-plus-oracle-proxy-server.html" },
    ...
    { key = "/concepts/changelogs/attributes/using-psql-integration.html", website_redirect = "/tools-integrations/native-executors/use-psql-integration.html" },
    { key = "/concepts/changelogs/attributes/using-sqlcmd-integration.html", website_redirect = "/tools-integrations/native-executors/use-sqlcmd-integration.html" },
    { key = "/concepts/changelogs/attributes/using-sql-plus-and-oracle-proxy-user.html", website_redirect = "/tools-integrations/native-executors/use-sql-plus-oracle-proxy-server.html" },
    { key = "/concepts/changelogs/attributes/using-sql-plus-integration.html", website_redirect = "/tools-integrations/native-executors/use-sql-plus-integration.html" },
