...
variable "redirects" {
  default = [
    ...
    { key = "/mongodb", website_redirect = "/start/tutorials/mongodb/home.html" },
    ...
    { key = "/start/install/tutorials/mongo-db-atlas-config.html", website_redirect = "/start/tutorials/mongodb/mongodb-atlas-config.html" },
    ...
    { key = "/start/tutorials/mongodb-pro-user-roles.html", website_redirect = "/start/tutorials/mongodb/mongodb-pro-user-roles.html" },
