...
variable "redirects" {
  default = [
    ...
    { key = "/commands/quality-checks/checks/sql-server-future-reserved-keywords.html", website_redirect = "/commands/quality-checks/checks/changelog-checks/sql-server-future-reserved-keywords.html" },
    { key = "/commands/quality-checks/checks/sql-server-odbc-reserved-keywords.html", website_redirect = "/commands/quality-checks/checks/changelog-checks/sql-server-odbc-reserved-keywords.html" },
    ...
    { key = "/start/tutorials/mongodb-pro-aws-doc-config.html", website_redirect = "/start/tutorials/mongodb-pro/amazon-documentdb-tls-ssl.html" },
