...
variable "redirects" {
  default = [
    ...
    { key = "/commands/quality-checks/checks/object-name-must-match.html", website_redirect = "/commands/quality-checks/checks/database-checks/object-name-must-match.html" },
    { key = "/commands/quality-checks/checks/object-name-must-not-match.html", website_redirect = "/commands/quality-checks/checks/database-checks/object-name-must-not-match.html" },
    ...
    { key = "/commands/quality-checks/checks/table-column-limit.html", website_redirect = "/commands/quality-checks/checks/database-checks/table-column-limit.html" },
    { key = "/commands/quality-checks/checks/table-comment-check.html", website_redirect = "/commands/quality-checks/checks/database-checks/table-comment-check.html" },
    { key = "/commands/quality-checks/checks/table-comment-pattern-check.html", website_redirect = "/commands/quality-checks/checks/database-checks/table-comment-pattern-check.html" },
    ...
    { key = "/commands/quality-checks/object-name-must-match.html", website_redirect = "/commands/quality-checks/checks/database-checks/object-name-must-match.html" },
    { key = "/commands/quality-checks/object-name-must-not-match.html", website_redirect = "/commands/quality-checks/checks/database-checks/object-name-must-not-match.html" },
