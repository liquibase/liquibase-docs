...
variable "redirects" {
  default = [
    ...
    { key = "/drift-reports", website_redirect = "/tools-integrations/observability/operation-reports.html" },
    { key = "/drift-reports.html", website_redirect = "/tools-integrations/observability/operation-reports.html" },
