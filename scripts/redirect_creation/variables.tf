...
variable "redirects" {
  default = [
    ...
    { key = "/concepts/attributes/sql-plus-troubleshoot.html", website_redirect = "/tools-integrations/native-executors/sql-plus-troubleshoot.html" },
    { key = "/concepts/attributes/use-psql-integration.html", website_redirect = "/tools-integrations/native-executors/use-psql-integration.html" },
    { key = "/concepts/attributes/use-sqlcmd-integration.html", website_redirect = "/tools-integrations/native-executors/use-sqlcmd-integration.html" },
    { key = "/concepts/attributes/use-sql-plus-integration.html", website_redirect = "/tools-integrations/native-executors/use-sql-plus-integration.html" },
    { key = "/concepts/attributes/use-sql-plus-oracle-proxy-server.html", website_redirect = "/tools-integrations/native-executors/use-sql-plus-oracle-proxy-server.html" },
