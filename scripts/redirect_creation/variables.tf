...
variable "redirects" {
  default = [
    ...
    { key = "/commands/quality-checks/using-quality-checks-in-automation-severity-and-exit-code.html", website_redirect = "/liquibase-pro/policy-checks/workflows/automation-severity-exit-code" },
    ...
    { key = "/commands/quality-checks/workflows/use-quality-checks-auto-severity-exit-code.html", website_redirect = "/liquibase-pro/policy-checks/workflows/automation-severity-exit-code" },
    ...
    { key = "/concepts/advanced/using-quality-checks-in-automation-severity-and-exit-code.html", website_redirect = "/liquibase-pro/policy-checks/workflows/automation-severity-exit-code" },
