...
variable "redirects" {
  default = [
    ...
    { key = "/change-tracking/maintenance/tag.html", website_redirect = "/commands/change-tracking/tag.html" },
    ...
    { key = "/commands/community/dropall.html", website_redirect = "/commands/maintenance/drop-all.html" },
    ...
    { key = "/commands/dropall.html", website_redirect = "/commands/maintenance/drop-all.html" },
