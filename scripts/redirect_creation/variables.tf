...
variable "redirects" {
  default = [
    ...
    { key = "/start/tutorials/mongodb/mongodb-changelog-formats.html", website_redirect = "/start/tutorials/mongodb-pro/using-mongosh-changelog.html" },
    ...
    { key = "/start/tutorials/mongodb/using-mongosh-changelog.html", website_redirect = "/start/tutorials/mongodb-pro/using-mongosh-changelog.html" },
