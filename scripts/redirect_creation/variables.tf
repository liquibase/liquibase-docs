...
variable "redirects" {
  default = [
    ...
    { key = "/concepts/changelogs/attributes/sql-plus-troubleshoot.html", website_redirect = "/tools-integrations/native-executors/oracle-sqlplus-troubleshoot.html" },
    { key = "/concepts/changelogs/attributes/use-psql-integration.html", website_redirect = "/tools-integrations/native-executors/postgresql-psql" },
    { key = "/concepts/changelogs/attributes/use-sqlcmd-integration.html", website_redirect = "/tools-integrations/native-executors/mssql-server-sqlcmd.html" },
    { key = "/concepts/changelogs/attributes/use-sql-plus-integration.html", website_redirect = "/tools-integrations/native-executors/oracle-sqlplus.html" },
    { key = "/concepts/changelogs/attributes/use-sql-plus-oracle-proxy-server.html", website_redirect = "/tools-integrations/native-executors/oracle-sqlplus-proxy-user.html" },
    ...
    { key = "/concepts/changelogs/attributes/using-psql-integration.html", website_redirect = "/tools-integrations/native-executors/postgresql-psql" },
    { key = "/concepts/changelogs/attributes/using-sqlcmd-integration.html", website_redirect = "/tools-integrations/native-executors/mssql-server-sqlcmd.html" },
    { key = "/concepts/changelogs/attributes/using-sql-plus-and-oracle-proxy-user.html", website_redirect = "/tools-integrations/native-executors/oracle-sqlplus-proxy-user.html" },
    { key = "/concepts/changelogs/attributes/using-sql-plus-integration.html", website_redirect = "/tools-integrations/native-executors/oracle-sqlplus.html" },
    ...
    { key = "/operation-reports", website_redirect = "/tools-integrations/observability/operation-reports.html" },
    { key = "/operation-reports.html", website_redirect = "/tools-integrations/observability/operation-reports.html" },
    ...
    { key = "/start/tutorials/mongodb/mongodb-changelog-formats.html", website_redirect = "/tools-integrations/native-executors/mongodb-mongosh.html" },
    ...
    { key = "/start/tutorials/mongodb/using-mongosh-changelog.html", website_redirect = "/tools-integrations/native-executors/mongodb-mongosh.html" },
    ...
    { key = "/start/tutorials/mongodb-pro/mongodb-changelog-formats.html", website_redirect = "/tools-integrations/native-executors/mongodb-mongosh.html" },
    { key = "/start/tutorials/mongodb-pro/using-mongosh-changelog.html", website_redirect = "/tools-integrations/native-executors/mongodb-mongosh.html" },
