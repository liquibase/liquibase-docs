...
variable "redirects" {
  default = [
    ...
    { key = "/commands/quality-checks/concepts/using-quality-checks-in-automation-severity-and-exit-code.html", website_redirect = "/liquibase-pro/policy-checks/workflows/automation-severity-exit-code" },
