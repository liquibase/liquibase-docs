...
variable "redirects" {
  default = [
    ...
    { key = "/commands/quality-checks/checks/changelog-checks/require-changeset-dis-uuid.html", website_redirect = "/liquibase-pro/policy-checks/checks/changelog-checks/require-changeset-dis-uuid.html" },
    ...
    { key = "/commands/quality-checks/checks/require-chaneset-dis-uuid.html", website_redirect = "/liquibase-pro/policy-checks/checks/changelog-checks/require-changeset-dis-uuid.html" },
    ...
    { key = "/liquibase-pro/quality-checks/checks/changelog-checks/require-changeset-dis-uuid.html", website_redirect = "/liquibase-pro/policy-checks/checks/changelog-checks/require-changeset-dis-uuid.html" },
