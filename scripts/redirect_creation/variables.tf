...
variable "docs_access_key" {}

variable "docs_secret_key" {}
...
variable "redirects" {
  ...
  default = {
    ...
    "/commands/quality-checks/concepts/getting-started-with-the-checks-command.html"                           = "/commands/quality-checks/workflows/getting-started-with-the-checks-command.html"
    ...
    "/commands/quality-checks/concepts/using-quality-checks-in-automation-severity-and-exit-code.html"         = "/commands/quality-checks/workflows/using-quality-checks-in-automation-severity-and-exit-code.html"
