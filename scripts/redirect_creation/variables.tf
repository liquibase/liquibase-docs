...
variable "redirects" {
  default = [
    ...
    { key = "/enterprise/dmc/configure/user-group-project-config/manage-users-dmc.html", website_redirect = "/configure/user-group-project-config/manage-users-dmc.htm" },
