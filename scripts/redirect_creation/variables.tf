...
variable "redirects" {
  default = [
    ...
    { key = "/commands/flow/if-conditionals.html", website_redirect = "/commands/flow/conditionals.html" },
    ...
    { key = "/tools-integrations/labs/if-conditionals.html", website_redirect = "/commands/flow/conditionals.html" },
